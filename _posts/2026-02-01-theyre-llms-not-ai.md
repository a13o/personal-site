...
<figure>
  <img src="/assets/llms-not-ai/powerful_oz.jpg" alt="Scene from Wizard of Oz when Dorothy and friends meet the giant green face being controlled by the Wizard from behind a curtain.">
...
For some, the similarity between number files and brain wrinkles is an awfully big hint that LLMs are giving _intelligence_. But, isn't it just as likely to go in the other direction? Maybe whatever LLMs are, that's the base truth -- and **humans are like LLMs**.
...
1. Is there evidence suggesting LLMs are AI?
1. What are the implications of having AI in society?
